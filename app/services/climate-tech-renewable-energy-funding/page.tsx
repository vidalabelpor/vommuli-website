...
export default function ClimateTechRenewableEnergyFundingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-emerald-900 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 left-1/3 w-64 h-64 bg-lime-500/10 rounded-full blur-3xl animate-pulse delay-2000"></div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button className="group relative px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl text-lg font-semibold transition-all duration-300 hover:shadow-2xl hover:shadow-green-500/25 hover:scale-105 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-black text-green-400 mb-2">$2.8T</div>
              <div className="text-slate-300 font-medium">Global Climate Investment Market</div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-black text-emerald-400 mb-2">74%</div>
              <div className="text-slate-300 font-medium">ESG Investment Success Rate</div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-black text-lime-400 mb-2">180+</div>
              <div className="text-slate-300 font-medium">Climate Tech Investors Network</div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-black text-green-400 mb-2">5-12</div>
            ...
            <div className="relative bg-slate-800/50 backdrop-blur-sm p-12 border border-green-500/30">
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
                  ...
                  <button className="group relative px-8 py-4 border-2 border-white/30 text-white rounded-xl text-lg font-semibold transition-all duration-300 hover:bg-white hover:text-slate-900 backdrop-blur-sm hover:scale-105">
                    <span className="flex items-center">
                      Download Climate Investment Guide
                      <svg className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clipRule="evenodd" />
                      </svg>
                    </span>
