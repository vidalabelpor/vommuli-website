          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-blue-500/30">
                <h3 className="text-lg font-bold text-blue-400 mb-3">What makes AI funding different from traditional tech funding?</h3>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  ...
                  <div className="bg-slate-700/50 p-3 rounded">
                    <h4 className="font-medium text-white mb-1">AI-Specific DD</h4>
                    <ul className="text-slate-300 space-y-1">
                      <li>• Model performance</li>
                      <li>• Data quality & volume</li>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-indigo-500/30">
                <h3 className="text-lg font-bold text-indigo-400 mb-3">What technical documentation do AI investors require?</h3>
                <p className="text-slate-300 text-sm mb-4">
                ...
                <div className="space-y-3">
                  <div className="border-l-4 border-indigo-500 pl-4">
                    <h4 className="font-medium text-white mb-1">Core Technical Documents</h4>
                    <ul className="text-slate-300 text-sm space-y-1">
                      <li>• Model architecture & performance benchmarks</li>
                      <li>• Training data specifications & quality metrics</li>
                      <li>• Validation methodology & bias testing</li>
                      <li>• Scalability architecture & computational requirements</li>
                      <li>• IP portfolio & competitive differentiation</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-purple-500/30">
                <h3 className="text-lg font-bold text-purple-400 mb-3">How long does AI startup fundraising typically take?</h3>
                <p className="text-slate-300 text-sm mb-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-slate-300">Pre-Seed AI:</span>
                      <span className="text-purple-400">3-5 months</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-300">Seed AI:</span>
                      <span className="text-purple-400">4-6 months</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-300">Series A AI:</span>
                      <span className="text-purple-400">6-8 months</span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-400">3.2 per deal</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-cyan-500/30">
                <h3 className="text-lg font-bold text-cyan-400 mb-3">What AI market segments are most attractive to investors?</h3>
                <p className="text-slate-300 text-sm mb-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="space-y-2">
                    <div className="bg-green-500/20 p-2 rounded">
                      ...
                      <span className="text-slate-300 ml-2">Generative AI Apps</span>
                    </div>
                    <div className="bg-green-500/20 p-2 rounded">
                      <span className="text-green-400 font-medium">Hot:</span>
                      <span className="text-slate-300 ml-2">AI Infrastructure</span>
                    </div>
                    <div className="bg-yellow-500/20 p-2 rounded">
                      <span className="text-yellow-400 font-medium">Active:</span>
                      <span className="text-slate-300 ml-2">Enterprise AI</span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="bg-blue-500/20 p-2 rounded">
                      <span className="text-blue-400 font-medium">Emerging:</span>
                      <span className="text-slate-300 ml-2">AI Security</span>
                    </div>
                    <div className="bg-blue-500/20 p-2 rounded">
                      <span className="text-blue-400 font-medium">Growth:</span>
                      <span className="text-slate-300 ml-2">Vertical AI</span>
                    </div>
                    <div className="bg-purple-500/20 p-2 rounded">
                      <span className="text-purple-400 font-medium">Future:</span>
                      <span className="text-slate-300 ml-2">Quantum-AI</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-green-500/30">
                <h3 className="text-lg font-bold text-green-400 mb-3">How do you evaluate if an AI company is investment-ready?</h3>
                <p className="text-slate-300 text-sm mb-4">
                ...
                <div className="space-y-3">
                  <div className="border-l-4 border-green-500 pl-4">
                    <h4 className="font-medium text-white mb-2">Investment Readiness Checklist</h4>
                    <div className="grid grid-cols-2 gap-3 text-xs">
                      <div>
                        <h5 className="font-medium text-green-400 mb-1">Technical</h5>
                        <ul className="text-slate-300 space-y-1">
                          <li>• ✓ Proven model performance</li>
                          <li>• ✓ Scalable architecture</li>
                          <li>• ✓ Quality training data</li>
                          <li>• ✓ Bias testing completed</li>
                        </ul>
                      </div>
                      <div>
                        <h5 className="font-medium text-green-400 mb-1">Business</h5>
                        <ul className="text-slate-300 space-y-1">
                          <li>• ✓ Customer validation</li>
                          <li>• ✓ Clear value proposition</li>
                          <li>• ✓ Market size validation</li>
                          <li>• ✓ Revenue model clarity</li>
                        </ul>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-orange-500/30">
                <h3 className="text-lg font-bold text-orange-400 mb-3">What are typical AI startup valuation ranges by stage?</h3>
                <p className="text-slate-300 text-sm mb-4">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="bg-slate-700/50 p-3 rounded">
                      <h4 className="font-medium text-white mb-2">Funding Stages</h4>
                      <div className="space-y-1 text-xs">
                        <div className="flex justify-between">
                          <span className="text-slate-300">Pre-Seed:</span>
                          <span className="text-orange-400">$5M-15M</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-slate-300">Seed:</span>
                          <span className="text-orange-400">$15M-50M</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-slate-300">Series A:</span>
                          <span className="text-orange-400">$50M-150M</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-slate-300">Series B:</span>
                          <span className="text-orange-400">$150M-500M</span>
                        </div>
                      </div>
                    </div>
                    <div className="bg-slate-700/50 p-3 rounded">
                      ...
                      <ul className="text-slate-300 text-xs space-y-1">
                        <li>• Proven AI team (2-3x)</li>
                        <li>• Strong technical moats (1.5-2x)</li>
                        <li>• Enterprise traction (2x)</li>
                        <li>• Hot AI segment (1.5x)</li>
                        <li>• Strategic partnerships (1.3x)</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-violet-500/30">
                <h3 className="text-lg font-bold text-violet-400 mb-3">How do you help with AI investor introductions and matching?</h3>
                <p className="text-slate-300 text-sm mb-4">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3 text-xs">
                    <div className="bg-slate-700/50 p-3 rounded">
                      ...
                      <ul className="text-slate-300 space-y-1">
                        <li>• AI technology specialization</li>
                        <li>• Investment stage preference</li>
                        <li>• Sector focus alignment</li>
                    ...
                    <div className="bg-slate-700/50 p-3 rounded">
                      ...
                      <ul className="text-slate-300 space-y-1">
                        <li>• 85+ AI-focused partners</li>
                        <li>• $45B+ AI capital managed</li>
                        <li>• 340+ AI investments tracked</li>
                        <li>• 67% follow-on rate</li>
                        <li>• 12 avg days to response</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-pink-500/30">
                <h3 className="text-lg font-bold text-pink-400 mb-3">What ongoing support do you provide post-funding?</h3>
                <p className="text-slate-300 text-sm mb-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="bg-slate-700/50 p-3 rounded">
                    ...
                    <ul className="text-slate-300 space-y-1">
                      <li>• Investor onboarding support</li>
                      <li>• Board meeting preparation</li>
                      <li>• Milestone planning & tracking</li>
                      <li>• Early strategic introductions</li>
                    </ul>
                  </div>
                  <div className="bg-slate-700/50 p-3 rounded">
