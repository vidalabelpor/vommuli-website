...
export default function HealthcareMedTechFundingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-pink-900 relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30"></div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button className="group relative px-8 py-4 bg-gradient-to-r from-red-600 to-pink-600 text-white rounded-xl text-lg font-semibold transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/25 hover:scale-105 overflow-hidden">
      ...
      <section className="relative py-16 px-6 lg:px-8 z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Healthcare Funding Market Leadership</h2>
            <p className="text-slate-400">Driving innovation in medical technology and healthcare delivery</p>
          </div>
          
          <div className="grid lg:grid-cols-4 gap-8 text-center">
            <div className="bg-slate-800/40 backdrop-blur-sm p-8 rounded-2xl border border-red-500/30">
              <div className="text-4xl font-black text-red-400 mb-2">+42%</div>
              <p className="text-slate-300 text-sm mb-1">Healthcare Introduction Requests YoY</p>
              <p className="text-green-400 text-xs">Fastest growing healthcare segment</p>
            </div>
            
            <div className="bg-slate-800/40 backdrop-blur-sm p-8 rounded-2xl border border-pink-500/30">
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm p-8 rounded-2xl border border-rose-500/30">
              <div className="text-4xl font-black text-rose-400 mb-2">$2.7B</div>
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm p-8 rounded-2xl border border-orange-500/30">
              <div className="text-4xl font-black text-orange-400 mb-2">81%</div>
              <p className="text-slate-300 text-sm mb-1">Healthcare Startup Success Rate</p>
              <p className="text-green-400 text-xs">↑ 29% vs general market</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-24 px-6 lg:px-8 z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Healthcare Funding Advisory FAQ
            </h2>
            <p className="text-xl text-slate-400 max-w-4xl mx-auto">
              Comprehensive answers to the most common questions about healthcare startup funding, regulatory requirements, and our specialized medical technology advisory process.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-blue-500/30">
                <h3 className="text-lg font-bold text-blue-400 mb-3">What makes healthcare funding different from traditional tech funding?</h3>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="bg-slate-700/50 p-3 rounded">
                    <h4 className="font-medium text-white mb-1">Traditional Tech DD</h4>
                    <ul className="text-slate-300 space-y-1">
                  ...
                  <div className="bg-slate-700/50 p-3 rounded">
                    <h4 className="font-medium text-white mb-1">Healthcare-Specific DD</h4>
                    <ul className="text-slate-300 space-y-1">
                      <li>• Clinical evidence</li>
                      <li>• Regulatory pathway</li>
                      <li>• Reimbursement strategy</li>
                      <li>• Clinical team expertise</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-indigo-500/30">
                <h3 className="text-lg font-bold text-indigo-400 mb-3">What clinical documentation do healthcare investors require?</h3>
                <p className="text-slate-300 text-sm mb-4">
                  Healthcare investors typically require comprehensive clinical documentation including study protocols, clinical data reports, regulatory correspondence, safety profiles, efficacy endpoints, and competitive clinical benchmarking. We help prepare investor-ready clinical packages and regulatory summaries.
                </p>
                <div className="space-y-3">
                  <div className="border-l-4 border-indigo-500 pl-4">
                    <h4 className="font-medium text-white mb-1">Core Clinical Documents</h4>
                    <ul className="text-slate-300 text-sm space-y-1">
                      <li>• Clinical study reports & safety data</li>
                      <li>• Regulatory correspondence & FDA feedback</li>
                      <li>• Clinical development plan & milestones</li>
                      <li>• Regulatory pathway strategy & timeline</li>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-purple-500/30">
                <h3 className="text-lg font-bold text-purple-400 mb-3">How long does healthcare startup fundraising typically take?</h3>
                <p className="text-slate-300 text-sm mb-4">
                  Healthcare startup fundraising averages 6-12 months depending on development stage and regulatory complexity. Our clients typically complete funding 40% faster due to specialized investor targeting and clinical validation preparation. Timeline varies by therapeutic area and regulatory pathway.
                </p>
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-slate-300">Digital Health Seed:</span>
                      <span className="text-purple-400">4-7 months</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-300">MedTech Series A:</span>
                      <span className="text-purple-400">6-9 months</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-300">Biotech Series B:</span>
                      <span className="text-purple-400">8-12 months</span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-slate-300">Our Average:</span>
                      <span className="text-green-400">-40% faster</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      <span className="text-slate-300">Avg Term Sheets:</span>
                      <span className="text-green-400">2.8 per deal</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-cyan-500/30">
                <h3 className="text-lg font-bold text-cyan-400 mb-3">What healthcare market segments are most attractive to investors?</h3>
                <p className="text-slate-300 text-sm mb-4">
                  Current hot healthcare segments include digital therapeutics (+156% YoY funding), AI-powered diagnostics (+134% YoY), remote patient monitoring (+98% YoY), and precision medicine tools (+87% YoY). We track real-time investor interest across all healthcare verticals.
                </p>
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="space-y-2">
                    <div className="bg-green-500/20 p-2 rounded">
                      <span className="text-green-400 font-medium">Hot:</span>
                      <span className="text-slate-300 ml-2">Digital Therapeutics</span>
                    </div>
                    <div className="bg-green-500/20 p-2 rounded">
                      <span className="text-green-400 font-medium">Hot:</span>
                      <span className="text-slate-300 ml-2">AI Diagnostics</span>
                    </div>
                    <div className="bg-yellow-500/20 p-2 rounded">
                      <span className="text-yellow-400 font-medium">Active:</span>
                      <span className="text-slate-300 ml-2">Remote Monitoring</span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="bg-blue-500/20 p-2 rounded">
                      <span className="text-blue-400 font-medium">Emerging:</span>
                      <span className="text-slate-300 ml-2">Healthcare Cybersecurity</span>
                    </div>
                    <div className="bg-blue-500/20 p-2 rounded">
                      <span className="text-blue-400 font-medium">Growth:</span>
                      <span className="text-slate-300 ml-2">Precision Medicine</span>
                    </div>
                    <div className="bg-purple-500/20 p-2 rounded">
                      <span className="text-purple-400 font-medium">Future:</span>
                      <span className="text-slate-300 ml-2">Gene Therapy</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-green-500/30">
                <h3 className="text-lg font-bold text-green-400 mb-3">How do you evaluate if a healthcare company is investment-ready?</h3>
                <p className="text-slate-300 text-sm mb-4">
                  We assess healthcare companies across four key dimensions: clinical validation (safety, efficacy, clinical outcomes), regulatory strategy (FDA pathway, approval timeline), market access (reimbursement, adoption barriers), and team expertise (clinical advisory, regulatory experience). Our evaluation identifies gaps and readiness factors.
                </p>
                <div className="space-y-3">
                  <div className="border-l-4 border-green-500 pl-4">
                    <h4 className="font-medium text-white mb-2">Healthcare Investment Readiness</h4>
                    <div className="grid grid-cols-2 gap-3 text-xs">
                      <div>
                        <h5 className="font-medium text-green-400 mb-1">Clinical</h5>
                        <ul className="text-slate-300 space-y-1">
                          <li>• ✓ Clinical evidence quality</li>
                          <li>• ✓ Safety profile established</li>
                          <li>• ✓ Efficacy endpoints met</li>
                      ...
                      <div>
                        ...
                        <ul className="text-slate-300 space-y-1">
                          ...
                          <li>• ✓ Reimbursement pathway</li>
                          <li>• ✓ Clinical adoption plan</li>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-orange-500/30">
                <h3 className="text-lg font-bold text-orange-400 mb-3">What are typical healthcare startup valuation ranges by development stage?</h3>
                <p className="text-slate-300 text-sm mb-4">
                  Healthcare startup valuations vary significantly by development stage, clinical progress, and regulatory milestones. Current market ranges show healthcare companies commanding 2-4x premiums over traditional tech due to clinical barriers and regulatory validation requirements.
                </p>
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="bg-slate-700/50 p-3 rounded">
                      <h4 className="font-medium text-white mb-2">Development Stages</h4>
                      <div className="space-y-1 text-xs">
                        <div className="flex justify-between">
                          <span className="text-slate-300">Preclinical:</span>
                          <span className="text-orange-400">$3M-12M</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-slate-300">Phase I/II:</span>
                          <span className="text-orange-400">$8M-35M</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-slate-300">Phase II/III:</span>
                          <span className="text-orange-400">$25M-125M</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-slate-300">Commercial:</span>
                          <span className="text-orange-400">$75M-500M+</span>
                        </div>
                      </div>
                    </div>
                    <div className="bg-slate-700/50 p-3 rounded">
                      <h4 className="font-medium text-white mb-2">Premium Factors</h4>
                      <ul className="text-slate-300 text-xs space-y-1">
                        <li>• Clinical validation (2-4x)</li>
                        <li>• FDA breakthrough designation (1.5-3x)</li>
                        <li>• Strong clinical team (1.5-2x)</li>
                        <li>• Proven reimbursement (2x)</li>
                        <li>• Strategic partnerships (1.3-2x)</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-violet-500/30">
                <h3 className="text-lg font-bold text-violet-400 mb-3">How do you help with healthcare investor introductions and matching?</h3>
                <p className="text-slate-300 text-sm mb-4">
                  Our healthcare investor network includes 95+ specialized partners across medical device VCs, digital health funds, biotech investors, and strategic healthcare corporations. We match companies based on therapeutic area, development stage, regulatory pathway, and clinical expertise requirements.
                </p>
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3 text-xs">
                    <div className="bg-slate-700/50 p-3 rounded">
                      <h4 className="font-medium text-white mb-2">Matching Criteria</h4>
                      <ul className="text-slate-300 space-y-1">
                        <li>• Therapeutic area focus</li>
                        <li>• Development stage preference</li>
                        <li>• Regulatory experience</li>
                        <li>• Clinical advisory depth</li>
                        <li>• Market access capabilities</li>
                      </ul>
                    </div>
                    <div className="bg-slate-700/50 p-3 rounded">
                      <h4 className="font-medium text-white mb-2">Network Stats</h4>
                      <ul className="text-slate-300 space-y-1">
                        <li>• 95+ healthcare-focused partners</li>
                        <li>• $23B+ healthcare capital managed</li>
                        <li>• 287+ healthcare investments tracked</li>
                        <li>• 73% follow-on rate</li>
                        <li>• 14 avg days to response</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl border border-pink-500/30">
                <h3 className="text-lg font-bold text-pink-400 mb-3">What ongoing support do you provide for healthcare companies post-funding?</h3>
                <p className="text-slate-300 text-sm mb-4">
                  We provide comprehensive post-funding support including regulatory milestone planning, clinical advisory connections, reimbursement strategy development, follow-on fundraising coordination, and strategic partnership facilitation. Our goal is long-term partnership throughout your healthcare company's development journey.
                </p>
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="bg-slate-700/50 p-3 rounded">
                    <h4 className="font-medium text-white mb-2">Immediate (0-6 months)</h4>
                    <ul className="text-slate-300 space-y-1">
                      <li>• Regulatory milestone tracking</li>
                      <li>• Clinical advisory introductions</li>
                      <li>• Investor relations support</li>
                      <li>• Strategic partnership opportunities</li>
                    </ul>
                  </div>
                  <div className="bg-slate-700/50 p-3 rounded">
                    <h4 className="font-medium text-white mb-2">Long-term (6+ months)</h4>
                    <ul className="text-slate-300 space-y-1">
                      <li>• Follow-on fundraising strategy</li>
                      <li>• Market access planning</li>
                      <li>• Clinical development optimization</li>
                      <li>• Exit preparation & advisory</li>
                    </ul>
                  </div>
                </div>
              </div>
